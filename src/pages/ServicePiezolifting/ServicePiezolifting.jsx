...
export default function ServicePiezolifting() {
    ...
    <div className="Service">
        ...
        <div className="wrapper">
          <div className="left">
            ...
            <div className="bottom-block">
              <h2>{t("service_piezolifting_title")}</h2>
              <div className="desc-block">
                <img src={arrow} alt="arrow" />
                <p>{t("service_piezolifting_description")}</p>
              </div>
            </div>
          </div>
          <div
          ...
          >
            <span>{t("service_piezolifting_title")}</span>
      ...
      <div className="Description">
        <div className="wrapper">
          ...
          <h2>{t("service_piezolifting_shorttitle")}</h2>
          <div className="block">
            <div className="row">
              <span>{t("service_piezolifting_question1")}</span>
              <p>{t("service_piezolifting_answer1")}</p>
            </div>
            <div className="row">
              <span>{t("service_piezolifting_question2")}</span>
              <p>{t("service_piezolifting_answer2")}</p>
            </div>
            <div className="row">
              <span>{t("service_piezolifting_question3")}</span>
              <p>{t("service_piezolifting_answer3")}</p>
            </div>
          </div>
        </div>
      </div>

  ...
  const journeyData = [
    {
      ...
      spanTitle: t("journey_filling_step1_span"),
      text: t("journey_filling_step1_text"),
    },
    {
      title: t("journey_filling_step2_title"),
      spanTitle: t("journey_filling_step2_span"),
      text: t("journey_filling_step2_text"),
    },
    {
      title: t("journey_filling_step3_title"),
      spanTitle: t("journey_filling_step3_span"),
      text: t("journey_filling_step3_text"),
    },
    {
      title: t("journey_filling_step4_title"),
      spanTitle: t("journey_filling_step4_span"),
      text: t("journey_filling_step4_text"),
    },
  ];
    ...
    <div className="Service">
      ...
      <div className="Description">
        <div className="wrapper">
          ...
          <h2>{t("service_filling_shorttitle")}</h2>
          <div className="block">
            <div className="row">
              <span>{t("service_filling_question1")}</span>
              <p>{t("service_filling_answer1")}</p>
            </div>
            <div className="row">
              <span>{t("service_filling_question2")}</span>
              <p>{t("service_filling_answer2")}</p>
            </div>
            <div className="row">
              <span>{t("service_filling_question3")}</span>
              <p>{t("service_filling_answer3")}</p>
            </div>
          </div>
        </div>
      </div>

      ...
      <div className="Videos">
        <div className="wrapper">
          <div className="topBlock">
            ...
            <h2>
              {t("reviews_videos_title")}
              <span>{t("reviews_videos_title_span")}</span>
            </h2>
          </div>
          <div className="bottomBlock">
            <a
              ...
              style={{
                backgroundImage:
                  "url(https://instagram.fxyz1-1.fna.fbcdn.net/v/t51.2885-15/IMAGE_ID1.jpg)",
              }}
            >
            ...
            <a
              ...
              style={{
                backgroundImage:
                  "url(https://instagram.fxyz1-1.fna.fbcdn.net/v/t51.2885-15/IMAGE_ID2.jpg)",
              }}
            >
              <div className="overlay">▶</div>
            </a>
            <a
              ...
              style={{
                backgroundImage:
                  "url(https://instagram.fxyz1-1.fna.fbcdn.net/v/t51.2885-15/IMAGE_ID3.jpg)",
              }}
            >
              <div className="overlay">▶</div>
            </a>
            <a
              ...
              style={{
                backgroundImage:
                  "url(https://instagram.fxyz1-1.fna.fbcdn.net/v/t51.2885-15/IMAGE_ID4.jpg)",
              }}
            >
              <div className="overlay">▶</div>
            </a>

  ...
  const journeyData = [
    {
      ...
      spanTitle: t("journey_e_max_veneers_step1_span"),
      text: t("journey_e_max_veneers_step1_text"),
    },
    {
      title: t("journey_e_max_veneers_step2_title"),
      spanTitle: t("journey_e_max_veneers_step2_span"),
      text: t("journey_e_max_veneers_step2_text"),
    },
    {
      title: t("journey_e_max_veneers_step3_title"),
      spanTitle: t("journey_e_max_veneers_step3_span"),
      text: t("journey_e_max_veneers_step3_text"),
    },
    {
      title: t("journey_e_max_veneers_step4_title"),
      spanTitle: t("journey_e_max_veneers_step4_span"),
      text: t("journey_e_max_veneers_step4_text"),
    },
  ];
    ...
    <div className="Service">
        ...
        <div className="wrapper">
          <div className="left">
            ...
            <div className="bottom-block">
              <h2>{t("service_e_max_veneers_title")}</h2>
              <div className="desc-block">
                <img src={arrow} alt="arrow" />
                <p>{t("service_e_max_veneers_description")}</p>
              </div>
            </div>
          </div>
          <div
      ...
      <div className="Description">
        <div className="wrapper">
          ...
          <h2>{t("service_e_max_veneers_shorttitle")}</h2>
          <div className="block">
            <div className="row">
              <span>{t("service_e_max_veneers_question1")}</span>
              <p>{t("service_e_max_veneers_answer1")}</p>
            </div>
            <div className="row">
              <span>{t("service_e_max_veneers_question2")}</span>
              <p>{t("service_e_max_veneers_answer2")}</p>
            </div>
            <div className="row">
              <span>{t("service_e_max_veneers_question3")}</span>
              <p>{t("service_e_max_veneers_answer3")}</p>
            </div>
          </div>
        </div>
      </div>
      <div className="Journey">
        <div className="wrapper">
          <div className="topBlock">
            ...
            <h2>{t("journey_e_max_veneers_title")}</h2>
          </div>

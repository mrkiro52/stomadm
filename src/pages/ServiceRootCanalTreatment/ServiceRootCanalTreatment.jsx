    ...
    <div className="Service">
        ...
        <div className="wrapper">
          <div className="left">
            ...
            <div className="bottom-block">
              <h2>{t("service_root_canal_treatment_title")}</h2>
              <div className="desc-block">
                <img src={arrow} alt="arrow" />
                <p>{t("service_root_canal_treatment_description")}</p>
              </div>
            </div>
          </div>
          <div
      ...
      <div className="Description">
        <div className="wrapper">
          ...
          <h2>{t("service_root_canal_treatment_shorttitle")}</h2>
          <div className="block">
            <div className="row">
              <span>{t("service_root_canal_treatment_question1")}</span>
              <p>{t("service_root_canal_treatment_answer1")}</p>
            </div>
            <div className="row">
              <span>{t("service_root_canal_treatment_question2")}</span>
              <p>{t("service_root_canal_treatment_answer2")}</p>
            </div>
            <div className="row">
              <span>{t("service_root_canal_treatment_question3")}</span>
              <p>{t("service_root_canal_treatment_answer3")}</p>
            </div>
          </div>
        </div>
      </div>

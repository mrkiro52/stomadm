    ...
    <div className="Service">
        ...
        <div className="wrapper">
          <div className="left">
            ...
            <div className="bottom-block">
              <h2>{t("service_zirconia_crown_on_tooth_title")}</h2>
              <div className="desc-block">
                <img src={arrow} alt="arrow" />
                <p>{t("service_zirconia_crown_on_tooth_description")}</p>
              </div>
            </div>
          </div>
          <div
      ...
      <div className="Description">
        <div className="wrapper">
          ...
          <h2>{t("service_zirconia_crown_on_tooth_shorttitle")}</h2>
          <div className="block">
            <div className="row">
              <span>{t("service_zirconia_crown_on_tooth_question1")}</span>
              <p>{t("service_zirconia_crown_on_tooth_answer1")}</p>
            </div>
            <div className="row">
              <span>{t("service_zirconia_crown_on_tooth_question2")}</span>
              <p>{t("service_zirconia_crown_on_tooth_answer2")}</p>
            </div>
            <div className="row">
              <span>{t("service_zirconia_crown_on_tooth_question3")}</span>
              <p>{t("service_zirconia_crown_on_tooth_answer3")}</p>
            </div>
          </div>
        </div>
      </div>
